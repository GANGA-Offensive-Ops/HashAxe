...
_r(
    HashType(
        format_id="hash.mysql",
        canonical_name="MySQL native_password",
        hashcat_mode=300,
...
_r(
    HashType(
        format_id="hash.mssql2005",
        canonical_name="MSSQL 2005+",
        hashcat_mode=132,
        john_format="mssql05",
        difficulty="TRIVIAL",
        category="hash",
...
_r(
    HashType(
        format_id="hash.mssql2012",
        canonical_name="MSSQL 2012+",
        hashcat_mode=1731,
        john_format="mssql12",
        difficulty="FAST",
        category="hash",
...
_r(
    HashType(
        format_id="network.ntlmv1",
        canonical_name="NetNTLMv1",
        hashcat_mode=5500,
        john_format="netntlm",
        difficulty="FAST",
        category="network",
...
_r(
    HashType(
        format_id="network.ntlmv2",
        canonical_name="NetNTLMv2",
        hashcat_mode=5600,
...
_r(
    HashType(
        ...
        canonical_name="Kerberoast TGS RC4",
        hashcat_mode=13100,
        john_format="krb5tgs",
        difficulty="FAST",
        category="network",
...
_r(
    HashType(
        ...
        canonical_name="AS-REP Roast RC4",
        hashcat_mode=18200,
...
_r(
    HashType(
        ...
        canonical_name="Kerberos TGS AES128",
        hashcat_mode=19600,
        john_format="krb5tgs-aes128",
        difficulty="MEDIUM",
        category="network",
        gpu_supported=True,
...
_r(
    HashType(
        ...
        canonical_name="Kerberos TGS AES256",
        hashcat_mode=19700,
        john_format="krb5tgs-aes256",
        difficulty="MEDIUM",
        category="network",
        gpu_supported=True,
...
_r(
    HashType(
        ...
        canonical_name="DCC MS Cache v1",
        hashcat_mode=1100,
        john_format="DCC",
        difficulty="FAST",
        category="network",
...
_r(
    HashType(
        ...
        canonical_name="DCC2 MS Cache v2",
        hashcat_mode=2100,
        john_format="DCC2",
        difficulty="SLOW",
        category="network",
...
_r(
    HashType(
        ...
        canonical_name="Cisco Type 5 (md5crypt)",
        hashcat_mode=500,
        john_format="md5crypt",
        difficulty="FAST",
        category="network",
...
_r(
    HashType(
        ...
        canonical_name="Cisco Type 8 (PBKDF2)",
        hashcat_mode=9200,
        john_format="cisco8",
        difficulty="SLOW",
        category="network",
...
_r(
    HashType(
        ...
        canonical_name="Cisco Type 9 (scrypt)",
        hashcat_mode=9300,
        john_format="cisco9",
        difficulty="EXTREME",
        category="network",
...
_r(
    HashType(
        format_id="disk.dpapi",
        canonical_name="DPAPI Masterkey",
        hashcat_mode=15300,
        john_format="dpapimk",
        difficulty="SLOW",
        category="disk",
...
_r(
    HashType(
        ...
        canonical_name="Ansible Vault (AES-256)",
        hashcat_mode=16900,
        john_format="ansible",
        difficulty="SLOW",
        category="token",
...
_r(
    HashType(
        ...
        canonical_name="OpenSSH Private Key",
        hashcat_mode=22921,
        john_format="ssh",
        difficulty="MEDIUM",
        category="ssh",
...
def get_all_benchmarks() -> dict[str, dict[str, float]]:
    ...
    return {ht.format_id: dict(ht.benchmarks) for ht in HASH_REGISTRY.values() if ht.benchmarks}
