...
class TestWalletAnalysis:
    ...
    def test_weak_pbkdf2_critical(self):
        from hashaxe.web3.zk_auditor import ZKAuditor, AuditSeverity
        wallet = {
            "crypto": {
                "cipher": "aes-128-ctr",
                "kdf": "pbkdf2",
    ...
    def test_solana_keypair(self):
        from hashaxe.web3.zk_auditor import ZKAuditor, WalletType, AuditSeverity
...
class TestBackwardCompatibility:
    ...
    def test_original_full_report_api(self):
        from hashaxe.web3.zk_auditor import ZKAuditor, WalletAnalysis, AuditFinding, AuditSeverity
        auditor = ZKAuditor()
        wallet = WalletAnalysis(hashaxeable=True, findings=[
